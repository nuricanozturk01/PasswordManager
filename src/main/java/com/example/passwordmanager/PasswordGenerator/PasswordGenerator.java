...
import com.example.passwordmanager.PasswordGenerator.PGExceptions.CharacterCountNotMatchedException;
import com.example.passwordmanager.PasswordGenerator.PGExceptions.MinimumPasswordSizeException;
import com.example.passwordmanager.PasswordGenerator.PGExceptions.WrongPasswordSizeException;
...
public class PasswordGenerator implements IPasswordGenerator
{
    ...
    public String customizedGenerate()
    {
        ...
        {
            Methods.alertScreen(Alert.AlertType.WARNING,ex.getMessage(), ButtonType.OK);
        }
